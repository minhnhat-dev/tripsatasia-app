...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | Tripsatasia - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page Tripsatasia Dashboard Template",
};
