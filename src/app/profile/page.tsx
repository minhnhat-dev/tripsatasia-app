...
export const metadata: Metadata = {
  title: "Next.js Profile | Tripsatasia - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for Tripsatasia - Next.js Tailwind CSS Admin Dashboard Template",
};
